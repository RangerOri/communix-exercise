...
namespace GameLogic
{
	...
	public class GameManager : MonoBehaviour
	{
		...
		private bool gameOver;          //Set true when the game is over
		private bool wonGame;           //Set true when the game has been won
		...
		public Color[] colors;          //The color array of the bricks. This can be modified to create different brick color 

		void Start()
		{
			Initialize(); //Starts the game by setting values and spawning bricks
		}
		...
		public void Initialize()
		{
			...
			CreateBrickArray(brickCountX, brickCountY);
		}

		//Spawns the bricks and sets their colours
		public void CreateBrickArray(int brickCountX, int brickCountY)
		{
